...
DATETIME_START = datetime.datetime(2012, 7, 26, 0)
DATETIME_END   = datetime.datetime(2012, 7, 26, 0)
TIMEDELTA_NARR = datetime.timedelta(0, 24*60*60)

URL_ROOT = "http://nomads.ncdc.noaa.gov/data/gfs4/201207/"
DATA_DIR = '/global/scratch/sd/lgchen/data/GFS_4/Beijing_bigStormOnJul21/20120726'
