...
DATETIME_START = datetime.datetime(2012, 6, 28, 0)
DATETIME_END   = datetime.datetime(2012, 6, 30, 0)
TIMEDELTA_NARR = datetime.timedelta(0, 24*60*60)

URL_ROOT = "http://nomads.ncdc.noaa.gov/data/gfs4/201206/"
DATA_DIR = '/global/scratch/sd/lgchen/data/GFS_4/20120628'
