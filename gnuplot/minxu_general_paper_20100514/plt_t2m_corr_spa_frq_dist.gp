...
set output 'fig_t2m_corr_spa_frq_dist.ps'
set size 1.0, 1.0
...
set label 3 "Frequency (%)" at screen -0.05, 0.5 rotate by 90 center font "Times-Roman, 18"
set label 4 "Correlation coefficient of T2m over land"  at screen 0.5, -0.05 rotate by  0 center font "Times-Roman, 18"
...
set xtics ""
set ytics nomirror ("" 0.0, "5" 5.0, "10" 10, "15" 15, "20" 20)
set key Left reverse samplen 2 spacing 1
PosInt = "0"
set origin 0.0, 0.75
set label 21 "DJF" at 0.55, 18 font "Times-Roman, 12"
plot @FilNam @PosRad
...
PosInt = "1"
set origin 0.0, 0.50
set label 21 "MAM" at 0.55, 18 font "Times-Roman, 12"
plot @FilNam @PosRad

set ytics nomirror ("" 0.0, "5" 5.0, "10" 10, "15" 15, "20" 20)
PosInt = "2"
set origin 0.0, 0.25
set label 21 "JJA" at 0.55, 18 font "Times-Roman, 12"
plot @FilNam @PosRad

set xtics nomirror ("0.5" 0.5, "0.6" 0.6, "0.7" 0.7, "0.8" 0.8, "0.9" 0.9, "1.0" 1.0)
set ytics nomirror ("0" 0.0, "5" 5.0, "10" 10, "15" 15, "20" 20)
PosInt = "3"
set origin 0.0, 0.00
set label 21 "SON" at 0.55, 18 font "Times-Roman, 12"
plot @FilNam @PosRad
...
set xtics nomirror ("" 0.5, "0.6" 0.6, "0.7" 0.7, "0.8" 0.8, "0.9" 0.9, "1.0" 1.0)
PosInt = "3"
set origin 0.2, 0.00
plot @FilNam @PosRad
# ----------------------------------------------------------------------
