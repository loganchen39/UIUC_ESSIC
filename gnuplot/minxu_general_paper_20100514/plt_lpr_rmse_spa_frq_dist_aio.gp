...
set output 'fig_lpr_rmse_spa_frq_dist_aio.ps'
FilNam = "'./data_v3/land-rmse.dat.conv'"
Xrange = "(0.+$0*0.1)"
...
set label 4 "RMS Error of Daily Mean Precipitation (mm/day)"  \
...
plot @FilNam @PosRad, @FilNam @PosSfc, @FilNam @PosPbl, @FilNam @PosCup, @FilNam @PosCmp, \
      @FilNam using @Xrange:(column(38+@PosCol)*100) ti 'ENS1' w l lc 0 lw 4 lt 1
