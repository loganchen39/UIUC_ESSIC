...
set macros
set output 'fig_lpr_corr_spa_frq_dist_3.ps'

FilNam = "'./data_v3/corr3.dat.conv'"
...
set label 3 "Spatial Frequency over Central Great Plain (%)" at screen -0.05, 0.5 rotate by 90 center font "Times-Roman, 18"
