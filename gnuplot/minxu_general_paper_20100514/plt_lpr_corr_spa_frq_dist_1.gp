...
set macros
set output 'fig_lpr_corr_spa_frq_dist_1.ps'

FilNam = "'./data_v3/corr1.dat.conv'"
...
set label 3 "Spatial Frequency over Cascade (%)" at screen -0.05, 0.5 rotate by 90 center font "Times-Roman, 18"
