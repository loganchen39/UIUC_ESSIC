...
set output 'fig_opr_corr_spa_frq_dist_aio.ps'
...
set label 3 "Spatial Frequency over All Ocean Grids (%)" at screen -0.05, 0.5 rotate by 90 center font "Times-Roman, 18"
...
plot @FilNam @PosRad, @FilNam @PosSfc, @FilNam @PosPbl, @FilNam @PosCup, @FilNam @PosCmp, \
      @FilNam using @Xrange:(column(51+@PosCol)*100) ti 'ENS' w l lc 0 lw 4 lt 1
      #@FilNam using @Xrange:(column(40+@PosCol)*100) ti 'ENS2' w l lc 0 lw 4 lt 22
unset object 1
