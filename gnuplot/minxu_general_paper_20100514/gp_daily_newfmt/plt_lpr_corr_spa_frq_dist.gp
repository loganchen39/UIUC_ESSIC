...
set macros
set output 'fig_lpr_corr_spa_frq_dist.ps'
...
set label 91 "a) RA" at screen 0.0, 1.02 left font "Times-Roman, 12"
set label 92 "b) SF" at screen 0.2, 1.02 left font "Times-Roman, 12"
set label 93 "c) BL" at screen 0.4, 1.02 left font "Times-Roman, 12"
set label 94 "d) CU" at screen 0.6, 1.02 left font "Times-Roman, 12"
set label 95 "e) MP" at screen 0.8, 1.02 left font "Times-Roman, 12"
