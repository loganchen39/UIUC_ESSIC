...
FilNam1 = "'./data/annual-t2m1.dat'"
FilNam2 = "'./data/annual-t2m2.dat'"
FilNam3 = "'./data/annual-t2m3.dat'"
FilNam4 = "'./data/annual-t2m4.dat'"
...
set format x
#set xtics nomirror 0, 2, 12
set xtics nomirror ("0" 0.0, "2" 2.0, "4" 4., "6" 6., "8" 8., "10" 10., "12" 12.)
PosInt = "0"
set origin 0.0, 0.00
...
PosInt = "0"
PosCol = "0"
PosRad = "   using @Xrange:(column(39+@PosCol)-column(61)) @Titln10 @Styln10, \
          ...
          '' using @Xrange:(column(33+@PosCol)-column(61)) @Titln4 @Styln4, \
