...
set output 'fig_t2m_anl_cyc_v1_1.ps'
set size 1.0, 1.0
...
FilNam1 = "'./data_v3/annual-t2m1.dat.conv'"
FilNam2 = "'./data_v3/annual-t2m2.dat.conv'"
FilNam3 = "'./data_v3/annual-t2m3.dat.conv'"
FilNam4 = "'./data_v3/annual-t2m4.dat.conv'"
...
PosInt = "0"
PosCol = "1"
PosRad = "   using @Xrange:(column(9+@PosCol)-column(1)) @Titln9 @Styln9, \
          '' using @Xrange:(column(8+@PosCol)-column(1)) @Titln8 @Styln8, \
...
PosInt = "0"
PosCol = "1"
PosRad = "   using @Xrange:(column(14+@PosCol)-column(1)) @Titln6 @Styln6, \
          '' using @Xrange:(column(13+@PosCol)-column(1)) @Titln5 @Styln5, \
          '' using @Xrange:(column(12+@PosCol)-column(1)) @Titln4 @Styln4, \
          '' using @Xrange:(column(11+@PosCol)-column(1)) @Titln3 @Styln3, \
          '' using @Xrange:(column(10+@PosCol)-column(1)) @Titln2 @Styln2, \
...
PosInt = "0"
PosCol = "1"
PosRad = "   using @Xrange:(column(22+@PosCol)-column(1)) @Titln9 @Styln9, \
          '' using @Xrange:(column(21+@PosCol)-column(1)) @Titln8 @Styln8, \
          '' using @Xrange:(column(20+@PosCol)-column(1)) @Titln7 @Styln7, \
          '' using @Xrange:(column(19+@PosCol)-column(1)) @Titln6 @Styln6, \
          '' using @Xrange:(column(18+@PosCol)-column(1)) @Titln5 @Styln5, \
          '' using @Xrange:(column(17+@PosCol)-column(1)) @Titln4 @Styln4, \
          '' using @Xrange:(column(16+@PosCol)-column(1)) @Titln3 @Styln3, \
          '' using @Xrange:(column(15+@PosCol)-column(1)) @Titln2 @Styln2, \
          '' using @Xrange:(column(01+@PosCol)-column(1)) @Titln1 @Styln1 "
...
PosInt = "0"
PosCol = "1"
PosRad = "   using @Xrange:(column(30+@PosCol)-column(1)) @Titln9 @Styln9, \
          '' using @Xrange:(column(29+@PosCol)-column(1)) @Titln8 @Styln8, \
          '' using @Xrange:(column(28+@PosCol)-column(1)) @Titln7 @Styln7, \
          '' using @Xrange:(column(27+@PosCol)-column(1)) @Titln6 @Styln6, \
          '' using @Xrange:(column(26+@PosCol)-column(1)) @Titln5 @Styln5, \
          '' using @Xrange:(column(25+@PosCol)-column(1)) @Titln4 @Styln4, \
          '' using @Xrange:(column(24+@PosCol)-column(1)) @Titln3 @Styln3, \
          '' using @Xrange:(column(23+@PosCol)-column(1)) @Titln2 @Styln2, \
          '' using @Xrange:(column(01+@PosCol)-column(1)) @Titln1 @Styln1 "
...
PosInt = "0"
PosCol = "1"
PosRad = "   using @Xrange:(column(37+@PosCol)-column(1)) @Titln8 @Styln8, \
          '' using @Xrange:(column(36+@PosCol)-column(1)) @Titln7 @Styln7, \
          '' using @Xrange:(column(35+@PosCol)-column(1)) @Titln6 @Styln6, \
          '' using @Xrange:(column(34+@PosCol)-column(1)) @Titln5 @Styln5, \
          '' using @Xrange:(column(33+@PosCol)-column(1)) @Titln4 @Styln4, \
          '' using @Xrange:(column(32+@PosCol)-column(1)) @Titln3 @Styln3, \
          '' using @Xrange:(column(31+@PosCol)-column(1)) @Titln2 @Styln2, \
          '' using @Xrange:(column(01+@PosCol)-column(1)) @Titln1 @Styln1 "
